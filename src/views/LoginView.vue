<template>
  <section class="border-red-500 bg-gray-200 min-h-screen flex items-center justify-center">
    <div class="bg-gray-100 p-5 flex rounded-2xl shadow-lg max-w-3xl m-auto">
      <div class="md:w-1/2 px-5">
        <h2 class="text-2xl font-bold text-[#002D74]">Login</h2>
        <p class="text-sm mt-4 text-[#002D74]">Si ya tienes una cuenta, por favor logueate</p>
        <form class="mt-6" action="#" method="POST">
          ...
          <div class="mt-4">
            ...
            <input type="password" name="" id="" placeholder="Ingresa tu contraseña" minlength="6" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
        ...
        <div class="text-sm flex justify-between items-center mt-3">
          ...
          <button
            class="py-2 px-5 ml-3 bg-white border rounded-xl hover:scale-110 duration-300 border-blue-400  ">Registrate</button>
        </div>
      </div>
      ...
      <div class="w-1/2 md:block hidden ">
        <img
          ...
          class="rounded-2xl ml-5 mr-5" alt="page img">
      </div>
